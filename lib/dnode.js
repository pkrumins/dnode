...
function DNode (wrapper) {
    ...
    */
    self.withStream = function (stream, opts, block) {
        ...
        ready = true;
		  //console.log("withStream");
        //console.log("	stream:" + sys.inspect(stream));
        //console.log("");
...
//	     		console.log("	stream: " + sys.inspect(stream))
	     		console.log("	args: " + sys.inspect(kwargs))
	     		console.log("	port: " + sys.inspect(port))
	     		console.log("	callback: " + sys.inspect(block))
        		*/
...
//   	console.error('Remote error from client ' + remote.id + ':');
	   	console.error('Remote error from client ~please patch dnode/lib/dnode.js~');
		printError(err)
 }
